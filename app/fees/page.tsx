          ...
          <div className="text-center mb-16 px-6 sm:px-4 md:px-6">
            ...
            <div className="flex justify-center mb-8">
              <div className="bg-coral/20 border border-coral/30 rounded-2xl p-4 max-w-md">
                <p className="text-coral font-bold text-lg text-center">All Prices in Australian Dollars (AUD)</p>
              </div>
            </div>
                ...
                {pricingTiers.map((tier, index) => (
                  ...
                  >
                    <div className="text-center mb-6">
                      <h3 className="text-xl sm:text-2xl font-bold text-navy mb-2">{tier.platform}</h3>
                    ...
                    <div className="space-y-3">
                      {tier.pricing.map((price, priceIndex) => (
                        <div
                          key={priceIndex}
                          className="flex justify-between items-center py-3 px-3 sm:px-4 bg-gray-50 rounded-lg border border-gray-200"
                        >
                          <span className="text-navy font-medium text-sm sm:text-base">{price.range}</span>
            ...
            <div className="bg-slate-50/5 backdrop-blur-sm rounded-3xl p-4 sm:p-8 mb-16 mx-2 sm:mx-0">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-300">
                          We combine proprietary internal technology and AI to analyse content and policy violations
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                  ...
                  <p className="text-slate-300">
                    Often when a business comes to us, they've tried to report the content themselves. In their
                    attempts, their submission is not moderated or reviewed by a human, receiving an automated response
                    and rejection.
                  </p>
                </div>
              </div>
