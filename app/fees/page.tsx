    ...
    <div className="min-h-screen bg-gradient-to-br from-navy via-blue-900 to-blue-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
        ...
        <div className="py-8 relative">
          ...
          {/* Company Description */}
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 mb-16 border border-white/20 mx-6 sm:mx-0">
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-r from-coral to-orange-400 rounded-2xl p-4 sm:p-6 md:p-8 text-center shadow-2xl mb-24 mx-6 sm:mx-0">
