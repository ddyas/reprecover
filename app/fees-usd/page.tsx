...
export const metadata: Metadata = {
  title: "Pricing & Fees (USD) - RepRecover | Professional Content Removal Services",
  description:
    "Transparent USD pricing for professional content removal services. No removal, no fee guarantee. Expert reputation management for businesses and individuals.",
}

export default function FeesUSDPage() {
  const pricingTiers = [
    {
      ...
      averageTime: "14 days",
      pricing: [
        { range: "1-5 Reviews", price: "$490" },
        { range: "6-10 Reviews", price: "$440" },
        { range: "11-25 Reviews", price: "$415" },
        { range: "26-50 Reviews", price: "$380" },
    ...
    },
    {
      ...
      averageTime: "21 days",
      pricing: [
        { range: "1-5 Reviews", price: "$460" },
        { range: "6-10 Reviews", price: "$410" },
        { range: "11-25 Reviews", price: "$390" },
        { range: "26-50 Reviews", price: "$360" },
        { range: "50+ Reviews", price: "POA" },
      ],
    },
  ]
        ...
        <div className="py-8 relative">
          ...
          <div className="text-center mb-16 px-6 sm:px-4 md:px-6">
            ...
            <div className="flex justify-center mb-8">
              <div className="bg-coral/20 border border-coral/30 rounded-2xl p-4 max-w-md">
                <p className="text-coral font-bold text-lg text-center">All Prices in US Dollars (USD)</p>
              </div>
            </div>

            <p className="text-xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              The rise of self-verified digital content has created a need to protect the reputation of businesses
              against trolls, competition, disgruntled customers and biased ex-staff. RepRecover is an Australian based
              company making serious waves within a misunderstood corner of the internet.
            </p>
          ...
          <div className="bg-slate-50/5 backdrop-blur-sm rounded-3xl p-8 mb-16 mx-6 sm:mx-0">
            ...
            <div className="text-center mt-8">
              <p className="text-slate-400 text-sm">
                *POA = Price on Application. All prices in USD. Success rates based on historical data.
              </p>
            </div>
          </div>

          {/* Why Choose RepRecover Section */}
          <div className="bg-slate-50/5 backdrop-blur-sm rounded-3xl p-8 mb-16 mx-6 sm:mx-0">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-white mb-2">
                        In House Team with 5+ Years Industry Experience
                      </h3>
                      <p className="text-slate-300">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                ...
                <p className="text-slate-300 mb-4">
                  Content removal is a complicated process. There is a lack of information available to those affected
                  by misleading, unfair or otherwise negative content. For perspective, Google receive on average over
                ...
                <p className="text-slate-300">
                  ...
                  their submission is not moderated or reviewed by a human, receiving an automated response and
                  rejection.
                </p>
              </div>
            </div>
          ...
          <div className="bg-slate-50/5 backdrop-blur-sm rounded-3xl p-8 mb-16 mx-6 sm:mx-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {testimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-coral/30 transition-colors"
                >
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h4 className="text-lg font-semibold text-white">{testimonial.name}</h4>
                      <p className="text-sm text-slate-300">{testimonial.reviewsRemoved}</p>
                    </div>
